...
Dall'analisi effettuata è un dato di fatto che il modello attuale non faccia discriminazioni profonde: sia con SVM che con DT l'importance è sbilanciata in favore dell'attributo \texttt{shot_dist}. 
