...
Le metriche mostrano che la nostra SVM predice l'esito del tiro in maniera poco più che sufficiente ed è importante notare che predice meglio un tiro \texit{missed} da uno \textit{made}, come dimostrato dai valori delle due recall.
