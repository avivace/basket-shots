...
Abbiamo scelto di rendere anonime le istanze del nuovo dataset rimuovendo nomi di attaccanti e difensori, cosicchè il modello di di Machine Learning prevedano i risultati indipendentemente dai giocatori coinvolti, ma si basino sulle loro statistiche, sul contesto di gioco e sugli altri valori forniti.
